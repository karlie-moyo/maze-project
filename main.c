 ...
 * @Dated 01-05-2023
 * 
 * main: Main driver of the function for the entire program
 */
...
{   
    ...
    Sleep(500);
    system("color 07");
    printf("\n\nWelcome Doctor %s, to Green Chattel Franchise Travels and Tours\n", name);
    Sleep(500);
    printf("\nSelect an option:\n");
    printf("1: Story Mode\n");
    printf("2: Quick Play\n\t\t==> ");
    ...
    case '1': //Story Mode
    {
        system("cls");
        printf("\n\n--------------------------------------------------------------------------------");
        printf("\n\n       Good Day Doctor %s, I am Queen Karlie and I", name);
