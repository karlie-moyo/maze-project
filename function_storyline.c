...
/**
 * @Filename function_storyline.c
 * @Author Karlie Moyo
 * @Dated 02-05-2023
 *
 * game_start - function for start of game options
 * baluba_story - Story line for the baluba location
 * katanga_story - Story line for the katanga location
 * kalakuta_story - Story line for the kalatuka location
 * mallam_story - Story line for the mallam location
 *
 */
...
void game_start()
{
    ...
    else if (option == '3')
    {
        ...
        printf("\n\n\t  and developed in C programming language in May 2023 by");
        printf("\n\n\t  Karlie Moyo, for the MVP projects ;)");
        printf("\n\n\n\t============================================================\n");
...
void baluba_story()
{
    ...
    printf("\n  opportuned to visit prominent cities such as Capetown in South Africa, Abuja in Nigeria");
